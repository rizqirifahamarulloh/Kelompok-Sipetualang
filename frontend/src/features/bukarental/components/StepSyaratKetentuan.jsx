    ...
    <div className="flex gap-10 max-lg:flex-col max-lg:gap-8 py-10 px-6 max-w-[1100px] mx-auto">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="br-section-desc">
          Bacalah dengan teliti dokumen di bawah ini sebagai dasar kesepakatan kerjasama antara Anda dan SiPetualang.
        </p>
        ...
        <div className="br-sk-content">
          <h4>1. Pendahuluan</h4>
          <p>
            Perjanjian ini mengatur syarat dan ketentuan kemitraan antara pemilik alat outdoor ("Mitra") dan platform SiPetualang. Dengan mendaftar, Anda menyetujui untuk mematuhi seluruh kebijakan operasional yang ditetapkan.
          </p>
        ...
        <label className={`br-checkbox-card ${agree1 ? 'checked' : ''}`}>
          ...
          <div className="br-checkbox-label">
            ...
            <span>Menandai ini berarti Anda terikat secara hukum dengan syarat yang berlaku.</span>
          </div>
        </label>
