  ...
  return (
    <div className="py-10 px-6 max-w-[850px] mx-auto">
        ...
        <div className="bg-red-50 border border-red-200 rounded-2xl p-6 mb-8 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-red-700 text-xs leading-relaxed mb-3">
              Maaf, pengajuan verifikasi Anda ditolak karena: <strong className="bg-red-100 px-1 rounded">{rejectionNote}</strong>. Silakan unggah ulang foto KTP dan selfie yang lebih jelas sesuai panduan di bawah.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="bg-emerald-50 rounded-xl p-5 flex items-center gap-4 border border-emerald-100">
        ...
        <div>
          <h5 className="text-sm font-bold text-emerald-900 mb-0.5">Data Anda Terenkripsi</h5>
          <p className="text-xs text-emerald-700 leading-relaxed">
            Kami menjamin kerahasiaan dokumen Anda hanya untuk keperluan verifikasi internal ekosistem SiPetualang.
          </p>
        </div>
      </div>
