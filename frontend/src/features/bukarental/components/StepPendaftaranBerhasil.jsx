  ...
  return (
    <div className="py-16 px-6 max-w-[520px] mx-auto text-center">
      ...
      <p className="text-sm text-gray-500 leading-relaxed mb-10 max-w-[400px] mx-auto">
        {isPending ? (
          'Data Anda sudah terkirim, mohon tunggu untuk diverifikasi oleh tim admin kami. Proses ini biasanya memakan waktu maksimal 1x24 jam.'
        ) : (
          'Pendaftaran Anda telah berhasil diselesaikan. Akun Anda telah siap untuk mulai mengelola penyewaan peralatan outdoor dengan efisiensi profesional.'
        )}
      </p>
