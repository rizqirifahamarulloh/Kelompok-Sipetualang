...
export default function SidebarCard() {
  return (
    <div className="br-sidebar-card">
      <h3>Mulai Bisnis Sewa Outdoor Anda.</h3>
      <p>
      ...
      <div className="br-sidebar-feature">
        ...
        <div>
          ...
          <p>Terima pembayaran secara aman dan otomatis langsung ke rekening bank mitra Anda.</p>
        </div>
      </div>
      ...
      <div className="br-sidebar-feature">
        ...
        <div>
          ...
          <p>Sistem verifikasi penyewa yang ketat untuk menjamin keamanan barang-barang berharga Anda.</p>
        </div>
      </div>
    </div>
  )
