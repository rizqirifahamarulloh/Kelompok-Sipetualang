        ...
        <div className="container max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 border-b pb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative border rounded-xl overflow-hidden size-11 bg-emerald-600 hover:scale-105 hover:bg-emerald-700 transition flex items-center justify-center shadow-md text-white border-emerald-500">
