...
export default function TransactionsPage() {
 ...
 <div className="bg-card/80 /80 p-3 rounded-xl border border-border">
 ...
 * Keterlambatan pengembalian dikenakan denda Rp 20.000 per hari.
 ...
 <div>
 <label className="block text-xs font-semibold text-muted-foreground dark:text-muted-foreground mb-1.5">Metode Pengembalian</label>
 ...
 <label className="block text-xs font-semibold text-muted-foreground dark:text-muted-foreground mb-1.5">Nomor Resi / Kurir Pengembalian</label>
 <input
 type="text"
