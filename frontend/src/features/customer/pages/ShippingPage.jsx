...
export default function ShippingPage() {
  ...
  const getStatusStepClass = (currentStatus, targetStatus) => {
    ...
    return "bg-white border-slate-200 text-slate-400 dark:bg-slate-800 dark:border-slate-700"; // Pending step
  };
                ...
                {loading ? (
                  ...
                  <div className="space-y-8">
                    {data.map((item) => {
                      ...
                      return (
                        <div key={item.id_transaksi} className="border rounded-2xl p-6 bg-slate-50/30 space-y-6">
                          {/* Info Header */}
                          ...
                          <div className="relative py-4 px-2">
                            ...
                            <div className="grid grid-cols-4 text-center">
                              ...
                              <div className="flex flex-col items-center gap-2">
                                ...
                                <span className="text-[10px] font-bold text-slate-600 uppercase">Diproses</span>
                              </div>
                              ...
                              <div className="flex flex-col items-center gap-2">
                                ...
                                <span className="text-[10px] font-bold text-slate-600 uppercase">Dikirim</span>
                              </div>
                              ...
                              <div className="flex flex-col items-center gap-2">
                                ...
                                <span className="text-[10px] font-bold text-slate-600 uppercase">Tiba</span>
                              </div>
                              ...
                              <div className="flex flex-col items-center gap-2">
                                ...
                                <span className="text-[10px] font-bold text-slate-600 uppercase">Selesai</span>
                              </div>
                            </div>
                          </div>

                          {/* Info Detail Shipping */}
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white dark:bg-slate-900 border rounded-xl p-4 text-xs">
                            <div className="space-y-1.5">
                              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Detail Pengiriman</p>
                              {shipping ? (
                                <>
                                  <p className="text-slate-600 dark:text-slate-300">
                                    <strong className="text-slate-700">Kurir Pengantar:</strong> {shipping.kurir || "SiPetualang Delivery"}
                                  </p>
                                  <p className="text-slate-600 dark:text-slate-300">
                                    <strong className="text-slate-700">Nomor Resi:</strong> {shipping.no_resi || "-"}
                                  </p>
                                </>
                              ) : (
                                <p className="text-slate-500 italic">Penyedia sewa sedang mempersiapkan peralatan Anda di gudang.</p>
                              )}
                            </div>

                            <div className="space-y-1.5 border-t md:border-t-0 md:border-l md:pl-4 pt-3 md:pt-0">
                              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Posisi Terakhir</p>
                              {shipping ? (
                                <p className="text-slate-700 dark:text-slate-200 font-semibold flex items-center gap-1">
                                  <MapPin className="size-4 text-emerald-600 shrink-0" />
                                  {shipping.lokasi_terakhir}
                                </p>
                              ) : (
                                <p className="text-slate-500">Mempersiapkan penyerahan kurir.</p>
                              )}
                            </div>
                          </div>
