      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-3">
          <button 
            ...
            className="p-2 rounded-xl hover:bg-gray-100 transition text-gray-600 border border-gray-100 bg-white shadow-sm"
          >
            <ArrowLeft size={20} />
          </button>
          <div>
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <button className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2 border border-gray-200 rounded-xl text-xs font-bold bg-white text-slate-700 hover:bg-gray-50 transition">
            <Printer size={15} /> Cetak Struk
          </button>
          <button className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-emerald-800 text-white rounded-xl text-xs font-bold hover:bg-emerald-900 transition shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm space-y-3">
             <button className="w-full py-3 bg-emerald-100 text-emerald-800 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-emerald-200 transition">
               <CheckCircle2 size={18} /> Verifikasi Lunas
             </button>
             <button className="w-full py-3 bg-white text-rose-600 border border-rose-100 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-rose-50 transition">
