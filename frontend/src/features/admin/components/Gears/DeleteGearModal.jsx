    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/50 p-4">
      <div className="bg-card rounded-2xl w-full max-w-md shadow-2xl overflow-hidden border">
        <div className="p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-2">Hapus Alat?</h2>
          <p className="text-muted-foreground mb-8 leading-relaxed">
            Apakah kamu yakin ingin menghapus <strong className="text-foreground">{itemName}</strong>? Tindakan ini bersifat permanen dan seluruh data yang terkait akan ikut terhapus.
          </p>
          <div className="flex gap-3 justify-center w-full">
            <button onClick={onClose} className="flex-1 px-4 py-3 text-sm font-semibold text-muted-foreground bg-card border border-border rounded-xl hover:bg-muted transition">
              Batal
            </button>
